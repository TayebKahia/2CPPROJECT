...
{props.day.filter((object)=>{return object.heur ==="8-10"})[0].type ==="cour" ?<Cour type={props.day.filter((object)=>{return object.heur ==="8-10"})[0].type}  type={props.day.filter((object)=>{return object.heur ==="8-10"})[0].type}
...
{props.day.filter((object)=>{return object.heur ==="10-12"})[0].type ==="cour" ?<Cour type={props.day.filter((object)=>{return object.heur ==="10-12"})[0].type}  type={props.day.filter((object)=>{return object.heur ==="10-12"})[0].type}
...
{props.day.filter((object)=>{return object.heur ==="14-16"})[0].type ==="cour" ?<Cour type={props.day.filter((object)=>{return object.heur ==="14-16"})[0].type}  type={props.day.filter((object)=>{return object.heur ==="14-16"})[0].type}
...
{props.day.filter((object)=>{return object.heur ==="16-17"})[0].type ==="cour" ?<Cour type={props.day.filter((object)=>{return object.heur ==="16-17"})[0].type}  type={props.day.filter((object)=>{return object.heur ==="16-17"})[0].type}
